...
public class PlayerMenuUtility {
    ...
    public String getWarpToTeleport() {
        return warpToTeleport;
    }

    public void setWarpToTeleport(String warpToTeleport) {
        this.warpToTeleport = warpToTeleport;
    }
}
